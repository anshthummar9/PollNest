# Generated by Django 5.2.7 on 2026-02-28 11:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('polls', '0002_alter_poll_created_at'),
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='poll',
            name='community',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polls', to='polls.community'),
        ),
    ]
